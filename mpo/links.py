...
def pdfs_urls_to_csv(
    filename='links.csv', urls=START_URLS, base_url=BASE_URL, headers=HEADERS
):
...
def get_url_for_year(year: str, links_filename='links.csv'):
    with open(links_filename, newline='') as csvf:
